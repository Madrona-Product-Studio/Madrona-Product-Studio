...
The precise values, curves, and rules behind Madrona Motion. Cite these in
findings instead of approximating. Distilled from Emil Kowalski's design
engineering philosophy ([animations.dev](https://animations.dev/)).
