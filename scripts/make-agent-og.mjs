 ...
 * Refreshed 2026-08-30 to the frond identity (charcoal field, one orange).
 *
...
<link href="https://fonts.googleapis.com/css2?family=Hanken+Grotesk:wght@500;600;700&family=Inter:wght@600;700&family=Figtree:wght@600;700&display=swap" rel="stylesheet">
<style>
  * { margin:0; padding:0; box-sizing:border-box; }
  html,body { width:1200px; height:630px; }
  .og {
    width:1200px; height:630px; position:relative;
    background:#2F3135; color:#F7EDE4;
    padding:76px 80px; display:flex; flex-direction:column; justify-content:space-between;
    font-family:Inter, system-ui, sans-serif; overflow:hidden;
  }
  
  .head { display:flex; align-items:center; gap:14px; }
  .head b { font-size:26px; font-weight:600; letter-spacing:.16em; color:#F7EDE4; font-family:Figtree, Inter, sans-serif; }
  .head span { font-size:13px; font-weight:600; letter-spacing:.22em; text-transform:uppercase; color:#E55728; font-family:Figtree, Inter, sans-serif; border-left:1.5px solid rgba(247,237,228,.32); padding-left:14px; }
  .body { margin-top:auto; }
  .tag { display:inline-block; font-size:19px; font-weight:700; letter-spacing:.16em; text-transform:uppercase; color:#E55728; margin-bottom:22px; }
  h1 { font-family:"Hanken Grotesk", Inter, sans-serif; font-weight:600; font-size:${c.name.length > 16 ? 86 : 104}px; line-height:1.02; letter-spacing:-.02em; color:#F7EDE4; max-width:19ch; }
  .sub { font-size:26px; color:rgba(247,237,228,.6); margin-top:24px; }
  .foot { display:flex; align-items:center; justify-content:space-between; }
  .foot span { font-size:20px; font-weight:600; color:rgba(247,237,228,.45); }
  .berry { display:flex; gap:9px; }
  .berry i { width:20px; height:20px; border-radius:50%; display:block; }
  .berry i:nth-child(1){ background:#FAF3EC; } .berry i:nth-child(2){ background:#8F6B7E; } .berry i:nth-child(3){ background:#E55728; }
</style></head>
<body><div class="og">
  <div class="head"><b>MADRONA</b><span>Product<br>Studio</span></div>
  <div class="body">
  ...
  <div class="foot">
    <span>madronaproduct.com/tools</span>
