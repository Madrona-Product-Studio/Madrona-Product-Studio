        ...
        <ArticleBody share={{ title: "Review-requests agent — a working demo", href: HREF }}>
          ...
          <ArticleSection id="deploy" num="3" eyebrow="Start small" title="Put it on your reviews.">
            <Prose>
              ...
              <p>When it fits, we connect your Business Profile and point of sale, set the ask rules, teach it your voice, and hand it over. Yours to keep &mdash; no lock-in.</p>
            </Prose>
