        ...
        <ArticleBody share={{ title: "The 12 jobs AI tools already do for small businesses", href: HREF }}>
          ...
          <ArticleSection id="how-to-start" num="6" eyebrow="The move" title="How to actually start.">
            <Prose>
              ...
              <p>Then take the free path first. Anthropic runs a free AI fluency course for small business owners, built with PayPal, and free half-day workshops in cities around the country. Gemini is already in your Workspace subscription. Shopify Magic is on every Shopify plan. You may get this job handled without spending anything new, and you should be suspicious of anyone who suggests otherwise.</p>
