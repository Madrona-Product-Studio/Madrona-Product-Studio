...
export default function MadronaV2PrinciplesNote() {
  ...
  return (
    <main className="m2 m2-ab-page">
      <LabMeta title="Madrona Principles · Thinking" noindex />
      <M2Nav active="pov" />

      {/* Hero */}
      <section className="m2-ab4 m2-th-hero">
        <p className="m2-kicker m2-who-kicker"><Link className="m2-pb-crumb" to="/thinking">Thinking</Link> · Essay · Aug 2026</p>
