...
function serviceModules(service: ServiceArea): Module[] {
  ...
  const mods: Module[] = [
    ...
    { kicker: "Where we begin", title: "Make the problem concrete before making the solution bigger.", body: service.bestFor, to: "/ai-opportunities", linkLabel: "Find your AI opportunities", artifact: "list", items: service.problems.slice(0, 4), listLabel: "Typical problems" },
