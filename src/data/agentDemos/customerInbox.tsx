...
export const customerInbox: AgentDemo = {
  id: "customer-inbox",
  title: "Customer-email agent: a working demo",
  ...
  spec: { runs: "Continuously", approve: "Every reply before it sends", setup: "A few days" },
  pipeline: [
    { name: "Read", d: "Reads new customer messages as they arrive.", icon: "mail" },
    { name: "Draft", d: "Answers the routine ones from your FAQ, in your voice.", icon: "pen" },
    { name: "You approve", d: "Every reply waits for you. Sensitive ones it won’t touch.", icon: "shield", gate: true },
    { name: "Send", d: "Sends what you approve; logs the rest.", icon: "send" },
  ],
  script: {
  ...
  caption: "A scripted run on Berry Good Berry Farm, our demonstration business. The messages are made up; the draft-and-hold behavior is the real one.",
  how: {
    title: "Answers the easy ones. Knows the hard ones.",
    lede: <>Most customer email is the same six questions. The agent handles those in your voice and, crucially, recognizes the message that isn&rsquo;t routine and steps back.</>,
  },
  honest: {
    lede: <>The drafting is easy. Two things decide whether it&rsquo;s trustworthy.</>,
    needs: <>Written answers to draw from: your hours, your policies, your shipping and return rules. If it isn&rsquo;t written down, the AI guesses, confidently. An afternoon writing your ten most common answers is the highest-leverage hour here.</>,
    ends: <>The upset customer. The agent drafts the routine ones and holds the rest for you. Draft with AI, but the message that needs a human, you send yourself.</>,
  },
  deploy: {
    title: "Put it on your inbox.",
    body: [
      <>It starts with a free 30-minute conversation. We&rsquo;ll tell you in writing where this would actually help on your inbox, and where it wouldn&rsquo;t.</>,
      <>When it&rsquo;s a fit, we write your FAQ into it, teach it your voice and what to never touch, set the approval gate, and hand it over. Yours to keep, no lock-in.</>,
    ],
  },
};
