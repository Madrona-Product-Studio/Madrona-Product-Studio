...
// Post-sale follow-up agent, run on Berry Good. Drafts thank-yous, win-backs,
// and check-ins in the owner's voice and queues them for approval. It never
// sends on its own. The service issue wearing a review's clothes is handed
// back to the human; that boundary is the point.
...
export const postSaleFollowup: AgentDemo = {
  id: "post-sale-followup",
  title: "Post-sale follow-up agent: a working demo",
  ...
  spec: { runs: "Daily", approve: "Every message before it sends", setup: "A few days" },
  pipeline: [
    { name: "Watch", d: "Watches for sales, and for regulars going quiet.", icon: "eye" },
    { name: "Draft", d: "Writes the right note for each moment.", icon: "pen" },
    { name: "You approve", d: "Nothing sends until you okay it.", icon: "shield", gate: true },
    { name: "Send", d: "Sends and schedules the follow-ups.", icon: "send" },
  ],
  script: {
  ...
  caption: "A scripted run on Berry Good Berry Farm, our demonstration business. The customers and messages are made up; the draft-and-hold behavior is the real one.",
  how: {
    title: "The follow-up you never get to.",
    lede: "Every sale is a chance to say thanks, and every quiet regular is a chance to win them back, but nobody has the time, so it never happens. The agent runs the rhythm and holds the moment that needs a person.",
  },
  honest: {
    lede: "Sending the notes is easy. Two things decide whether it earns its place.",
    needs: "A follow-up rhythm: who hears from you, how soon after a sale, saying what. An hour deciding that once; then the agent runs it forever.",
    ends: "The tools execute cadence; they don’t know your regulars. And a service issue wearing a review’s clothes still needs you.",
  },
  deploy: {
    title: "Put it on your customers.",
    body: [
      "It starts with a free 30-minute conversation. We’ll tell you in writing where this would actually help with your customers, and where it wouldn’t.",
      "When it fits, we wire your store and inbox, set the rhythm you decide, teach you how it runs, and hand it over. Yours to keep, no lock-in.",
    ],
  },
};
