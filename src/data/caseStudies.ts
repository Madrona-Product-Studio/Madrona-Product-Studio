...
export const caseStudies: CaseStudy[] = [
  ...
  },
  {
    ...
    heroImageAlt:
      "Helm's desktop command center: a focus-area sidebar beside a ranked top-priorities list (ship the redesign beta, finalize the Q3 roadmap, close the staff PM hire, prep the QBR deck).",
    opportunity:
    ...
    whatWeDid: {
      ...
      items: [
        ...
        },
        {
          ...
          description: "Because the brain is just text, the view can be whatever the moment calls for. On a desktop it opens into a two-pane command center, focus areas down the side and the work in front of you. On a phone it collapses to a single focused column you thumb through between meetings. Same file, same edits, no second codebase and no separate data model, just a layout that fits the screen.",
        },
        {
          ...
          imageAlt: "An action sheet on the task Ship the mobile redesign beta, offering Done, Unstar, and Update with AI.",
          caption: "Tap any line and Update with AI turns plain-language intent (prep the QBR deck before Thursday) into a clean, structured edit to the file.",
        },
        {
    ...
    status: [
      "In daily use as the way we actually run the studio and everything around it. Built by Madrona Product Studio, and in active development.",
  ...
  },
  {
    ...
    borderImages: true,
    category: "recent",
    externalUrl: "https://www.plainlytherapy.com/",
    externalLabel: "plainlytherapy.com",
